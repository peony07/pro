...
public class mzitu extends BaseImageImpl implements ReptileInterface {

	private static final Log log = LogFactory.getLog(mzitu.class);
	...
	protected void aLinkListExpend(Map map) throws Exception {
		...
		Elements alinks2 = doc2.select("div[class=page]>a");
	...
	protected String getaname(Element alink){
		 return alink.select("img").attr("alt");
	}
