...
public class mimiai extends BaseImageImpl implements ReptileInterface {

	private static final Log log = LogFactory.getLog(mimiai.class);

	protected String appendUrl(int num){
		return urlInfoBean.getUrl() +"&page="+ num ;
	}
}
